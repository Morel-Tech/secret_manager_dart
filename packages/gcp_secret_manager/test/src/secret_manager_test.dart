...
void main() {
  group('SecretManager', () {
    test('can be instantiated', () {
      expect(GCPSecretManager(MockSecretManagerApi(), ''), isNotNull);
    });
    ...
    group('getSecret', () {
      test('retrieves the latest secret', () async {
        ...
        final secretManager = GCPSecretManager(secretManagerApi, 'project-id');
    ...
    group('defaultCredentials', () {
      test('returns a new secret manager', () async {
        ...
        expect(
          await GCPSecretManager.defaultCredentials(
